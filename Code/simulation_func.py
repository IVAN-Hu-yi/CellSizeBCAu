...
def sim_sub_parallel(N, M, assemblenum, para:Paras, tstop, teval, p, number, D, l, rho, vmax, m, avgm,subcommunity_size=50, num_subcommunity=20, scale=True):

    ### simulation func for parallel processing
    ### initialised parametres
    # data storage
    R_assembles = []
    C_assembles = []
