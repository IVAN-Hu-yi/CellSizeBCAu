...
def sim_fuc(name, N, M, para:Paras, assemblenum, tstop, teval, num_subcommunity, subcommunity_size, avgm, tol=1e-3, scale=True):
...
if __name__ == "__main__":
    ...
    for j, w in enumerate(w_array):
        ...
        Ra, Ca, ta, paraa, idxs = sim_fuc(j, N, M, para_sep, assemblenum, tstop, teval, num_subcommunity, subcommunity_size, avgm=avgm, tol=tol)
